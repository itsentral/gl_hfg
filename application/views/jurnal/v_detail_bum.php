						...
						<form action="<?= base_url() ?>index.php/report/filter_query_jurnal" method="post">
							<table width="100%">
								<tr>
									...
									<td width="20%">
										<input type="text" class="form-control input-sm" size='1' id="filter_text" name="filter_text" value="<?= $data_header->no_reff ?>" readonly>
									</td>
								</tr>
								<tr>
									<td><br></td>
								...
								<tbody>
									...
									<tr bgcolor='#DCDCDC'>
										<td colspan="8" align="left">
											...
											<a href="<?= base_url() ?>index.php/multi_bum/print_bum/<?= $row->nomor ?>" target="_blank" title="Print" class='btn btn-info'><i class="fa fa-print"></i> Print</a>&nbsp;
