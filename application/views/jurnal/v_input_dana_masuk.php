					...
					<div class="box-body">
						<div class="form-group row">
							...
							<div class="col-sm-4">
								...
								<input type="date" class="form-control" size='1'  name="tanggal_tampil" value="<?= date('d-m-Y') ?>" data-date-format="yyyy-mm-dd">
...
<script>
	...
	$(document).ready(function() {
		...
		$('#simpan-bro').click(function(e) {
			...
			if (tgl == '' || tgl == null || tgl == '-') {
				close_spinner();
				alert('Tanggal Belum diinput, mohon input tgl terlebih dahulu..');
