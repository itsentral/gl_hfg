...
<table width="100%">
	...
	<tr class="widget-user-header bg-yellow">
		...
		if ($data_bulan_post > 0) {
			...
			if ($nm_bln == 1) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : Januari " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 2) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : Februari " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 3) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : Maret " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 4) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : April " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 5) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : Mei " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 6) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : Juni " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 7) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : Juli " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 8) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : Agustus " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 9) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : September " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 10) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : Oktober " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} elseif ($nm_bln == 11) {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : November " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			} else {
				echo "<th width='60%' style='text-align:center;font-size:15px;'><center>LAPORAN LABA RUGI<br>Periode : Desember " . $data_tahun_post . "<br>" . $nama_cabang . "</center></th>";
			}
		}
