		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<div class="box-body">
						<button class="btn btn-primary btn-sm" onclick="return add_coa()">Tambah COA <i class="fa fa-plus"></i></button>
							...
							<tbody>
								...
								?>
										<tr bgcolor='#DCDCDC'>
											...
											<td align="center">
												<button class='btn btn-primary btn-sm' onclick="return edit_coa(<?= $row->id ?>)">
...
<script>
	...
	function add_coa() {
		...
		$.get("<?= base_url(); ?>index.php/master/add_coa_master", {
			option: ""
		}, function(data) {
	...
	function edit_coa(id) {
		$.get("<?= base_url(); ?>index.php/master/edit_coa", {
			option: id
		}, function(data) {
			$('#show_stock').html(data);
			$('#myModal').modal('show');
