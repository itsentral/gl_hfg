							...
							<table class="table table-bordered table-hover dataTable example1">
								...
								<tbody>
									...
									<tr>
										...
										$vd  = $this->db->query("SELECT * FROM waterco_live.master_supplier WHERE id_suplier='$vendor'")->row();
										$supp  = $this->db->query("SELECT * FROM waterco_live.master_supplier WHERE id_suplier='$vendor'")->result();
										...
										echo "<tr><th colspan='8' style='text-align:center;font-size:15px;'><center>NAMA SUPPLIER : " . $vd->name_suplier . "</center></th></tr>";
										}
										else{
										$supp  = $this->db->query("SELECT * FROM waterco_live.master_supplier")->result();
									...
									$supplier = $cust->id_suplier;	
									$nm_klien = $cust->name_suplier;	
									$coa_sa = $this->Kartuhutang_model->GetData($awal,$supplier);
									...
									<!-- DATA DARI JURNAL -->
											...
											$detail_jurnal	= $this->Kartuhutang_model->get_detail_kartu_hutang($awal,$akhir,$supplier);
											if ($detail_jurnal > 0) {
												$count2 = 0;
												$count3 = 0;
